...
If you face 'permission denied' issues, you might need to add your user to the
Docker group. Follow these steps:
...
This step is necessary to apply the group membership changes. After logging
back in, you should be able to run Docker commands without sudo.

Alternatively, you can use the following command to apply the group changes
...
Following these steps will help you resolve permission issues and enable you
to pull and run the Docker container without using `sudo`.
