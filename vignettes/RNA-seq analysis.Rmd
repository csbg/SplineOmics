...
design <- "~ 1 + Condition*Time + Plate"
dream_params <- list(random_effects = "(1|Reactor)")

voom_obj <- SplineOmics::preprocess_rna_seq_data(
  raw_counts = data,
  meta = meta,
  spline_params = spline_params,
  # Interaction of Condition with Time (X), Plate is batch effect and Reactor is
  # random effect.
  design = design,
  dream_params = dream_params     # Because we have a random effect.
)
