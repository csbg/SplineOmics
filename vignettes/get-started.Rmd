...
report_dir <- file.path(tempdir(), "ora_reports")
dir.create(report_dir, showWarnings = FALSE, recursive = TRUE)
...
downloaded_dbs_filepath <- file.path(report_dir, "databases.tsv")
...
result <- SplineOmics::run_ora(
  clustering_results = clustering_results[["cluster_summary"]],
  databases = databases,
