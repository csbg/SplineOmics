...
# The amount of clusters are always specified as a range (due to technical
# reasons) even when you want to have one definite value. Specify 1:1 if you
# don't want to do clustering for this level.
nr_clusters <- list(
  6:6, # specifically 6 clusters for the exponential phase level
  2:3  # clusters for the stationary phase level, test 2 and 3 and decide with              silhuette score (automatically)
)
