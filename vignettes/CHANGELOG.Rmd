...
- New user-available function that allows to correlate the topTable results from
  two SplineOmics results (for example intergrated vs. isolated approach with
  the same data).
