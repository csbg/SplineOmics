...
1. **Reactor**:
   ...
   or temperature-shifted. As a result, **condition and reactor are confounded**.
...
result <- SplineOmics::run_gsea(
    # A dataframe with three columns: feature, cluster, and gene. Feature
    # contains
    # the integer index of the feature, cluster the integer specifying the
    # cluster
