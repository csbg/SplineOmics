#' Generate Scatter Plot Report for Each Feature with Embedded Base64 Images
#'
...
# 
#       # Create the ggplot object ensuring the y-values match the length of 'Time'
#       p <- ggplot2::ggplot(valid_data, ggplot2::aes(x = Time, y = Value)) +
#         ggplot2::geom_point(size = 0.5, na.rm = TRUE) +  # Filter out NA values
