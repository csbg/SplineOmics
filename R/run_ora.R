...
#' feature sets using the R package \strong{clusterProfiler}. For each grouping
...
#' (e.g., \code{create_ora_report()}), enabling a strict separation between
...
#' \describe{
#'   \item{\code{all_results}}{
#'     A nested, named list containing the raw over-representation analysis
#'     results for each grouping column in \code{cluster_table}. Each top-level
#'     element corresponds to one grouping column and contains the field
#'     \code{ora_results}, a nested list of enrichment results organized by
...
#'     is intended to be passed to \code{create_ora_report()}.
#'   }
#' }
#'
