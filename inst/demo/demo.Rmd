...
Make sure all the required packages for this analysis script are installed.
Part of these packages are not dependencies of the SplineOmics package, that is
why they could be missing.
