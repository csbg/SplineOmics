...
Because some functions of the dplyr package have names that are also used by 
base R functions, it is good practice to explicitly state the preference with
