...
- Updated package documentation (README, vignettes, and FAQ) to match
  the current API: ORA workflow, analysis/report splits, spline dof
  tuning, and missing-value guidance.
