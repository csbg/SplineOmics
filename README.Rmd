...
-   Find out which hyperparameters, such as degree of freedom, are needed for the limma spline analysis
...
-   Cluster the hits (the significant features) based on their temporal pattern.
...
-   **Run GSEA with the clustered hits:** The `gsea_report()` function takes the clustered hits and performs a gene set enrichment analysis, using clusterProfiler, with them.
