...
To preprocess the glycan fractional abundance data matrix, you need to apply the centered log ratio (CLR) transformation using the `clr` function from the `compositions` package. This transformation is essential for converting the compositional data into a form suitable for multivariate analysis.
