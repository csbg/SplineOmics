...
![Graphical Abstract](man/figures/SplineOmics_graphical_abstract.png)
...
-   [▶️ Usage](#-usage)
    ...
    -   [Preprocessing of RNA-seq and glycan fractional abundance data](#-preprocessing-of-rna-seq-and-glycan-fractional-abundance-data)
