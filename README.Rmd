...
You can pull the Docker container of the desired version of the `SplineOmics` 
package from Docker Hub using the following command (here it downloads version
0.1.0):
